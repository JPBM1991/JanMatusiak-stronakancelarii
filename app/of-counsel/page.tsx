      ...
      >
        <Container maxWidth="lg" sx={{ px: { xs: 3, md: 6 } }}>
          ...
          <Typography sx={{
            ...
            Kancelaria współpracuje z doświadczonymi prawnikami i doradcami
            w wybranych dziedzinach. Pozwala to zapewnić wsparcie prawne
            również w obszarach wymagających wąskiej specjalizacji.
          </Typography>
        </Container>
      </Box>
            ...
            {[
              {
                ...
                detail: "Zakładanie, przekształcenia, reorganizacje, obsługa organów spółek, zmiany struktury właścicielskiej.",
                href: "/praktyka#prawo-korporacyjne",
              },
              {
                area: "Kontrakty i negocjacje",
                detail: "Negocjowanie i przygotowywanie umów inwestycyjnych, term sheets, SPA, NDA, shareholders agreements.",
